...
namespace wikitude::sdk::opengl {
        ...
        void DrawRectangle::setEnabled(bool enabled_) {
            _enabled = enabled_;
        }
        
        void DrawRectangle::setScale(sdk::Scale2D<float> scale_) {
            _scale = scale_;
        }
        
        void DrawRectangle::setUniformScale(float uniformScale_) {
            _scale = {uniformScale_, uniformScale_};
        }
        
        void DrawRectangle::render(sdk::Matrix4& matrix_, wikitude::sdk::Matrix4& projection_) {
            if ( _enabled )
            {
        ...
        void DrawRectangle::release() {
            deleteShaders();
        }
        
#pragma mark - Private Methods
        GLuint DrawRectangle::compileShader(std::string shaderSource_, GLenum shaderType_) {
        ...
        void DrawRectangle::compileShaders() {
        ...
        void DrawRectangle::deleteShaders() {
            if ( _augmentationProgram ) {
