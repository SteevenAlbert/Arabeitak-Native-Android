...
@TargetApi(22)
public class MyCameraX implements Camera {
    ...
    public void startCamera() {
        ...
        cameraHelper.startCamera(
                (Activity) context, cameraFacing, /*unusedSurfaceTexture=*/ null, null);
    }
                ...
                if (!closeCalled) {
                    ...
                    try {
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                            ...
                            SessionConfiguration sessionConfiguration = new SessionConfiguration(SessionConfiguration.SESSION_REGULAR, Collections.singletonList(outputConfiguration), executor, sessionStateCallback);
    ...
    public MyCameraX(Context context, CameraCallback callback, int frameWidth, int frameHeight) {
