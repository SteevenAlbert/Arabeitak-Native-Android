...
var World = {
    ...
    createOverlays: function createOverlaysFn() {
         ...
         */
        this.targetCollectionResource = new AR.TargetCollectionResource("assets/image_targets.wtc", {
        ...
        */
        ...
        /* Create overlay for the farmer. */
        var imgFarmer = new AR.ImageResource("assets/holo_farmer.jpg", {
            onError: World.onError
        });
        var overlayFarmer = new AR.ImageDrawable(imgFarmer, 1);
        ...
        */
        this.farmer = new AR.ImageTrackable(this.tracker, "holo_farmer", {
            drawables: {
                cam: overlayFarmer
            },
            onError: World.onError
